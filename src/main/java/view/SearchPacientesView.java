 ...
 * @author dudaf
 */
public class SearchPacientesView extends javax.swing.JFrame {

    /**
     * Creates new form SearchPacientes
     */
    public SearchPacientesView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecione um paciente para continuar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchPacientesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchPacientesView().setVisible(true);
            }
        });
    }
