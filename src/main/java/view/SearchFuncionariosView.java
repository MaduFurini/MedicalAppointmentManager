 ...
 * @author dudaf
 */
public class SearchFuncionariosView extends javax.swing.JFrame {

    /**
     * Creates new form SearchPacientes
     */
    public SearchFuncionariosView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnConfirmar.setBackground(new java.awt.Color(198, 165, 255));
        btnConfirmar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnConfirmar.setForeground(new java.awt.Color(255, 255, 255));
        btnConfirmar.setText("Confirmar");

        jLabel2.setText("Selecione um funcionário para continuar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchFuncionariosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchFuncionariosView().setVisible(true);
            }
        });
    }
